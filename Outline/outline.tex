...
\title{\textbf{Living Alignment}\\[4pt] \large A Detailed Outline of the Argument}
\author{}
\date{\normalsize\today}
...
\noindent\textit{This document is a point-by-point outline of the argument made in} Living Alignment \textit{(the paper in the} Long Paper \textit{folder). It tracks the substantive claims in the body text, at roughly the granularity of individual points---sometimes a paragraph, sometimes several paragraphs making one point, sometimes several points within one paragraph. The abstract and the epigraph quotations are not covered.}
