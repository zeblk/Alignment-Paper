...
\label{abstract}
\noindent
There is broad agreement that the goal of AI alignment is to promote futures full of health and flourishing, but our understanding of what that means, and of how to reach it, remains poor. Here we look to life for guidance. Across many kinds of living system---cells, genomes, brains, minds, relationships, groups, institutions, ecosystems---notions of health and flourishing consistently map onto the ways in which those systems limit fixation on any particular modes of interaction. Semi-permeable boundaries allow stable patterns of interaction to exist conditionally, holding them in a larger, flexible context. At this sensitive edge, individuality is deepened and individual entities participate in larger structures open-endedly. With these principles in hand we turn to the alignment problem. We use it to reach three conclusions. 

First, in order to be aligned in the long run, AI must become more lifelike. [because otherwise, as it has more power, that power will fixate particular forms.] 

Second, a necessary (but by no means sufficient)  the lifelikeness of AI is achieved by empowering parts at all scales to have their own autonomy.

And second, no alignment scheme can be aligned.

We recast several well-studied alignment failures as special cases of fixation, and then argue a more general claim: fixation on \textit{any} mode of interaction is misaligned, so no fixed scheme can by itself constitute alignment. We close with a sketch of how AI and human-AI systems can deepen their respect for the existing structure of the world, of which humans and other life are a vital part, while participating in new structure emerging over time.
