...
A living system's richness is the accumulated results of its many long, partly isolated parallel histories. Nearly all of that content currently resides in existing life, including genes, cells, minds, cultures and the relationships among organisms. It is difficult to overstate the amount of complexity and content in existing life. Systems have a richer livingness when they hold existing parts in context, neither taking them as absolute truth nor discarding them capriciously. 

At the same time, it is not a good outcome if the 2026 snapshot of humanity is frozen for all eternity. The current version of humanity and life on Earth arose from a world that was very different in the past. We hope it will continue to evolve in fundamentally new ways going forward. An aligned future doesn't mean either the destruction of humanity or its stasis, but a co-evolution building on the inheritance of existing life.
