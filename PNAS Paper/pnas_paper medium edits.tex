...
While lack of barriers can lead to collapse, the presence of barriers ideally sets up an intricate balance in which new niches and new functions can emerge. For example, plants evolved toxins as self-defense against plant-eating insects, and these new barriers may have been a major driver of the diversification of insects \citep{futuyma2009macroevolution}. The network of constraints translates local optimization pressure into generative potential.
