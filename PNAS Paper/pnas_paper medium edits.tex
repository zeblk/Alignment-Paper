...
\label{abstract}
\noindent
There is broad agreement that the goal of AI alignment is to promote futures full of health and flourishing, but our understanding of what that means and how to achieve it remains poor. Here we look to the science of life for guidance. Across scales, from genomes to ecosystems, we observe that notions of health and flourishing consistently map to the ways in which those systems limit fixation on any particular mode of interaction. Fixation is limited by semi-permeable barriers that make modes of interaction conditional, causing multiple entities to develop distinct, modular identities in parallel and promoting open-ended invention of new structure. With these principles in mind, we turn to the alignment problem. We suggest that to be aligned, AI and human-AI systems must limit fixation with evolving barriers at all scales.
...
While lack of barriers can lead to collapse, the presence of barriers ideally sets up an intricate balance in which new niches and new functions can emerge. For example, plants evolved toxins in defense against plant-eating insects, and these new barriers are theorized to have been a major driver of the diversification of insects \citep{futuyma2009macroevolution}. The network of constraints translates local optimization pressure into generative potential.

% Beavers create new physical environments. In the Mesozoic marine revolution, predators evolved the ability to eat animals with shells, and this constraint drove 
...
Teams, companies, and civilizations achieve what no individual can \citep{henrich2016secret, hutchins1995cognition}. These achievements fundamentally depend on communication and information exchange \citep{sawyer2017group, mesmermagnus2009information}. It is intuitive why communication is beneficial for group problem solving: it enables coordination, spreading good solutions, recombining specialized knowledge, and catching errors. 

It is less intuitive why excess or premature information exchange can be suboptimal. A controversial thread of research has investigated degradations in performance when groups homogenize \citep{lazer2007network, frey2021social, janis1972victims}. \cite{zollman2010epistemic} tells the story of how a single study, using an inadequate staining method, failed to find bacteria in human gastric biopsies. In Zollman's account, this one study was too influential: it helped marginalize investigation of bacterial ulcer causes for decades. As a controlled experiment, \cite{bernstein2018intermittent} tasked small groups with solving traveling-salesman problems. Because of the complexity of these problems, it's possible to get stuck in dead-end solutions that initially appear promising. Groups that alternated between working independently and sharing answers outperformed both groups that shared continuously (which converged too early) and groups that never shared (whose best solutions could not spread).



In the real world, aggregation is often modular and compositional. Goldsmiths and coin engravers used steel punches to reproduce letters and designs in metal. In parallel, screw presses had been refined over centuries for wine and oil production. Gutenberg drew on both technologies to construct his printing system \citep{johnson2010where}. A group with many ideas and specializations available, each developed through the unique pressures of its own context, is ripe for such compositional discoveries \citep{derex2016partial}.

These case studies and findings hint that semi-permeable barriers can be useful in group problem solving: neither instant communication of every thought nor information blackout is optimal. The best-performing groups in Bernstein et al.'s experiment experienced a semi-permeable barrier: temporary isolation followed by interchange. Other semi-permeable barriers include geographical or cultural bottlenecks, skepticism, protecting dissent, group structures that reduce domination, and valuing epistemic over rhetorical quality. When barriers are effective, they both encourage individuals (or subgroups) to discover their own independent solutions, and allow these ideas to join productively \citep{surowiecki2005wisdom}. The greatest achievements of groups arguably depend on structured interactions of individuals with their own specializations and perspectives, developed through unique life trajectories experienced in parallel. 

% In one condition, members could see each other's answers continuously. These groups achieved a good average score, but converged prematurely and rarely found the very best solutions. In a second condition, members worked in isolation. Individuals pursued their own ideas in parallel, some of which turned out to be superior. These groups often found excellent solutions, but their average was low because good solutions could not spread. In a third condition, groups alternated between independence and sharing. These groups performed well on both measures: their best solutions matched those of isolated groups, and their average scores were high.

% Two threads of literature have sparred over whether 

% Some literature polarizes into camps that either claim `exchange is good' or `exchange is bad'. 
...
Inhibitory circuits constrain the strength and timing of excitation and sharpen stimulus selectivity \citep{isaacson2011inhibition}. Models of visual cortex propose that it disentangles visual properties like object identity, position and scale, making them separately accessible to downstream circuits \citep{dicarlo2012how}. The circuit architecture of the hippocampus creates sharp representational distinctions between different experiences, preventing interference between memories and concepts \citep{leutgeb2007pattern,yassa2011pattern}.
...
Alignment is the continued dance of contextualizing any particular form, more fully respecting the staggering subtlety of the existing world, and open-endedly supporting new robust depth that admits more and more different kinds of description. In this way, AI can participate in intense flourishing of an evolving world even far beyond current human conceptualization. 
...
We thank Clark Potter, Iason Gabriel, Zach Duer, Andy Savoy, Paul Krueger, Sean Wilkinson and Ethan Guggenheimer for insightful discussions, contributions to earlier drafts, inspiration and advice.
