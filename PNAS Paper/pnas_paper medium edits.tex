...
The thesis of Section 1 is that health and flourishing are related to limiting fixation on particular modes of interaction. Healthy living systems instead sustain a buoyant internal structure that both admits many kinds of description and also changes over time.  On the other hand, when systems fixate on particular patterns of interaction, they are unhealthy, as in loss of biodiversity in an ecosystem, cancer, hypersynchronous neural firing in a seizure, obsession with a particular thought, or the imposition of one person's will to restrict many others.

We will use the term `collapse' to refer to the transition to fixation.

In fixation, some aspect or subpart of the system gains excess traction or permanence at the expense of broader diversity, flexibility and dynamism. 
