...
The more we think of AI systems as having cognitive properties, the more the application of effective barriers looks like `decentering' (see page~\pageref{sec:frames}). Initially, something is fixatedly a part of the structure of the observer, but then it transitions to becoming flexibly represented as content by the observer. The transition from subject to object is arguably a central element of our own livingness, and this kind of internal discovery will probably play a central role in the healthy future of AI and human-AI systems.
