...
There are distinct patterns all across the world that influence each other. The tendency toward local collapse is counterbalanced by the fact that influence is limited and the world is changing. At some crucial balance point, it becomes a kind of bootstrapping where local influence is actually generative rather than collapsing. 
