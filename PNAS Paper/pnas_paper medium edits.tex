...
\subsection*{Example: reward hacking}
...
So, to sustain an aligned future, we must keep developing new barriers in an ongoing way. But---isn't that what humans have always done? We don't expect what we build today to be perfect; we expect to keep finding and fixing problems. 

However, AI has some unique properties increasing the risk that limiting mechanisms do not keep up. The most significant of these is the potential for fully general superhuman intelligence and recursive self-improvement \citep{bostrom2014superintelligence}. Such systems could be so powerful and rapidly adapting that humans would not be able to find and fix problems. 

Even before the arrival of superhuman AI, systems increasingly are acting autonomously, faster than humans can follow, in ways humans cannot always fully understand. Companies and nations are under immense competitive pressure to develop capabilities rapidly. Enormous financial investments in AI demand enormous returns. And the sheer rate of change swamps normal human and social mechanisms for putting effective limits into action. 

These conditions may create a special risk of excess influence. Any particular pattern of interaction---within an AI system or in the relationship of that system to the rest of the world---could become fixated without barriers to limit it. 

The coarsest versions of fixation are obvious: paperclips, bioweapons, extreme concentration of power. Less obvious versions. A subtle fixation at first appears harmless, but the system as a whole is collapsing toward something without contextualization. The pessimistic argument is that AI is eroding barriers beyond a healthy balance. AI systems could give great weight to narrow goals or ideas. They might facilitate rogue actors building weapons of mass destruction, or reduce the ability of democratic systems to check the power of a few individuals or authoritarian states. They might give everyone similar information and damage conceptual and cultural diversity. They might execute their own narrow goals destructively. If people and information systems across the globe become hyper-correlated, it is as if there were a single superorganism on Earth, which may reduce both resilience to shocks and the potential for future evolution---and past evolution always depended on running parallel experiments with diverse and separate organisms. As we reviewed with problem solving in groups, there is a simple concept in modeling studies that excessive network connectivity is prone to reaching mediocre solutions quickly and losing the diversity that sustains potential for reaching higher quality solutions over the long run \citep{lazer2007network, zollman2010epistemic}. \new{Conceptual monoculture leads to an impoverished future, or a loss of drive.}

The consequences could take the form of a dramatic collapse or a less-perceptible diminution of global vitality \citep{christiano2019failure}.
...
Conversely, things could be very good. 
...
There have always been distinct patterns all across the world that influence each other. But the tendency toward local collapse is counterbalanced by the fact that influence is limited and the world is changing. At some crucial balance point, it becomes a kind of bootstrapping where local influence is actually generative rather than collapsing. 
