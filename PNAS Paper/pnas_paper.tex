...
1) boundaries to avoid fixed arrangements $\rightarrow$ keeps it dynamic. this makes sex vs asex more natural. we'd have to argue how something like a law against theft is mitigating a ``fixed arrangement". boundaries keep life unsettled and evolving. we'd also have to argue how random noise is a ``fixed arrangement".

2) boundaries to avoid short-circuiting $\rightarrow$ keeps the internal bouyancy of life. 
