...
1) boundaries to avoid fixed arrangements $\rightarrow$ keeps it dynamic. this makes sex vs asex more natural. we'd have to argue how something like a law against theft is mitigating a ``fixed arrangement".
