...
In the following sections, we use examples from natural and human systems to illustrate how semi-permeable boundaries place intelligent constraints that limit collapse. In this light, we recast alignment as an evolving network of semi-permeable boundaries that contextualize any particular form of AI to support subtle functioning and ongoing arising of new, unknown structure. 
