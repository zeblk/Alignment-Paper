...
In the following sections, we first use examples from natural and human systems to show how semi-permeable boundaries place intelligent constraints that limit collapse. Applying this template, we then recast alignment as an evolving network of semi-permeable boundaries that contextualize any particular form of AI to avoid collapse and promote ongoing discovery of new structure. If you want to jump straight to alignment, it starts at Section~\ref{sec:alignment}. But those arguments will have more color if you read at least a few of the earlier sections first.
