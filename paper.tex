...
There is broad agreement that the goal of AI alignment is to promote futures full of health and flourishing. But our understanding of what exactly that means and how to achieve it remains poor. In this paper, we look to life for inspiration. Across many kinds of living system, we observe that notions of health and flourishing consistently map on to ways in which those systems defy formal descriptions. Life enacts intricate, interrelated semi-permeable boundaries that hold particular forms in context so the system does not collapse into degenerate modes. At this sensitive edge, individual perspectives are deepened and also participate in nuanced relationships, with qualitatively new structures emerging open-endedly over time. With these principles in mind, we turn to the alignment problem. We identify some well-studied problems in alignment as special cases of collapsing to excess formality. Then we outline a more general version of alignment using the language of living systems. We suggest that the semi-stable creative dynamics of life, and their resistance to formalization, can underpin a growing respect for existing structure in the world as well as the capacity to form new values over time. We end with a sketch of how aligned AI systems might participate in rather than overwhelm or collapse the subtlety of life.
...
In the rest of Section 1, we select a handful of examples to examine in more detail.
...
Individual actors in a society and in an economy each act from their own perspective. Each actor's perspective is myopic. Myopia can mean selfishly valuing only one's own wealth or physical wellbeing, which is short-sightedly fixed on the local individual. Myopia can also mean short-sightedness in time, underweighting the future. More broadly, it can mean attachment to any particular perspective. An actor cannot know everything or fully understand the motives and beliefs of others. 

% \citep{crockett2014harm, becker1974theory, henrich2001search}. But an actor . 

Without boundaries, social systems often overweight one actor's perspective or interests, resulting in an impoverished system. For example, a company's profit motive, if unresisted, leads to suppression of competition, deception, and exploitation of individuals \citep{dalrymple2019anarchy, baran1966monopoly, goldacre2014bad, smith1776inquiry, bakan2006corporation}. An individual's desire for power and social dominance can lead to disempowering or silencing of others and even direct infringement on the autonomy and wellbeing of others \citep{hawley2003prosocial, tepper2000consequences, sidanius2001social}. Even genuinely held, ostensibly prosocial beliefs lead to conflict and suppression when different groups have different perspectives \citep{haidt2012righteous, scott1998seeing, greene2013moral}.
...
An evolving system of boundaries limits overcommitment to any particular belief or mental form. The boundaries are semi-permeable: becoming aware of a belief doesn't make the belief wrong in an absolute sense any more than it was right in an absolute sense. It is held productively for the partial truth it contains. At the edge of not collapsing exclusively into particular forms, many partial truths are held in delicate balance, which activates a deeper sensitivity to our own livingness and to the world. Subtler forms, which could have been erased by clamped fixation on other forms, instead play a role in a richer overall internal structure. Our own potential within the world creatively emerges in continued newness. Of course, any concept of awareness is itself incomplete. Once we picture awareness as an object, it's not the thing we're talking about. By construction, contextualization is an unsolvable mystery from any particular point of view.
...
Clark Potter for planting these ideas. Iason Gabriel and Zach Duer for many insightful discussions and comments on multiple drafts of the paper.
