...
In one sense, what we value is whatever we say we value, or what we appear to value through our choices. We place value, in this sense, on gratification of our immediate desires, getting what we want, even if it's not good for us or others in a broader sense. Our stated preferences, or those revealed through our choices, are typically:
\begin{itemize} 
...
Perverse instantiation is overcommitment to the form of a particular reward function.   
...
Those were special cases of collapsing into narrow patterns. But the problem is broader. If we accept that real alignment means 
...
Overcommitment to a particular value function might be mitigated by designing AI systems that want to obey human preferences but treat these preferences as something uncertain that must be learned \citep{russell2019human, hadfieldmenell2017off, hadfieldmenell2016cooperative, shah2020benefits, jeon2020reward}. 
...
Systems can overcommit to particular values, to principles, algorithms for learning values, methods for reaching consensus, or even something as abstract as the concept of what a value is. 
