...
Each form -- an equation, a gene, a viewpoint, an institution -- is myopic in the sense that it is only a small aspect of the world. But the existence of many partial forms, maintaining separate identities while flexibly working together at many scales, constitutes the rich livingness of the world. Collapse is a failure mode where a loss of functional diversity results from forms excessively influencing one another. Another way of describing collapse is that interactions become overly rigid: there is a loss of separate flexibly interacting entities. Boundaries protect against collapse. Without sufficient boundaries, cancer spreads, concentrated power reduces human welfare, invasive species choke out complex ecosystems. 
...
Sexual reproduction is a boundary that creates modularity. In an asexually reproducing species, the genes within a lineage are stuck with each other forever. 

Fisher-Muller effect of generating new combinations.

Natural selection can't act on one gene without dragging along nearby genes: the genes are highly entangled with each other. This leads to slower adaptation \citep{hill1966effect, felsenstein1974evolutionary}, accumulation of deleterious mutations \citep{keightley2006interference, muller1932some}, and loss of genetic diversity \citep{charlesworth1993effect, hudson1995deleterious}. 
