...
At a social level, we have labs taking different approaches, nations with different cultures and strategic interests, ideas drawn from diverse fields like neuroscience and physics. How can we use AI in a way that does not lead to domination of individual perspectives? (and we might want to distinguish `concentration of power in the hands of elites' versus `collapse of global thought diversity without anyone necessarily benefitting'). Policies and regulations. Education, making sure everyone gets good at utilizing what is available.

Iterated amplification, where AI helps us think better, and we iterate on that cycle.

Processes for deliberation and inclusion. 


[do we want to consolidate the list of boundaries with section 2.2 where we list a few existing safety methods? and do we want to enumerate the limitations of each kind of method? it gets to be too much i think?]
