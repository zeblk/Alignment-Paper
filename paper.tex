...
We now apply this lens to the AI alignment problem. Our central message is that overcommitment to any particular form of AI means collapse, and AI carries a singular risk of overcommitment because of the extremities attached to it.

To illustrate this idea, let's start with a simple example. If AI begins to approach and exceed human-level general intelligence, it may accelerate its own development, creating a positive feedback loop and intelligence explosion \citep{good1965speculations, vinge1993coming}. If the explosion is coupled to a narrow goal or vision, it clearly constitutes an extreme form of collapse. Using Bostrom's classic example, imagine an AI whose sole objective is maximizing paperclip production \citep{bostrom2014superintelligence}. The system would be incentivized to continually improve its own intelligence and capabilities, recognizing this as the best way to increase future paperclip production \citep{silver2021reward, bostrom2012superintelligent}. The AI could thus become vastly more intelligent and capable than humans, wresting control of the Earth from us and transforming it entirely into a bleak paperclip factory. Recursive self-improvement charges the narrow paperclip goal with overwhelming force, causing overcommitment and collapse.
...
The extremities are:
- intelligence and speed. in some ways already superhuman.
- possibility of recursive self-improvement.
- concentration of attention and information flow in one place.
- intensity of optimization toward its objective function.
- tool for concentrating human power.



Thinking of the AlphaProof paper, there's a question: `is it really generalizing?'. Or is it collapsing on some narrower manifold? Is it going to hinder us from discovering deeper mathematics? Actually, a better way to say it is this: *whatever* manifold it has discovered is inevitably something partial. What will constrain it to say, `this is not the whole truth; keep being pressured to grow'? Something has to understand *it* (i.e., be aware of it) in order to contextualize it. Like, we'd have to be able to see the limits in its understanding and conceptualization.



The greatest extremity attached to AI is the possibility of super-human intelligence. 
...
\textbf{Exceeding human abilities.} AI's most distinctive feature is its capacity to replicate and possibly surpass human intelligence and agency. This creates a fundamentally new problem: it is difficult to control an agent more intelligent than ourselves.




\textbf{Recursive improvement and runaway intelligence}

Finally, the most extreme version of overcommitment is recursive self-improvement.  If AI approaches human-level intelligence, it will likely be able to improve itself at least as quickly. As AI then begins to exceed human intelligence, it may plausibly begin to improve itself even faster, creating a positive feedback loop and an intelligence explosion \citep{good1965speculations, vinge1993coming}. 
...
\subsection{Overcommitment to particular forms of AI} 
...
\section{Consequences of getting alignment wrong}

Despite its adaptiveness, law has historically not always been an effective boundary for checking the power of the most elite individuals and most successful businesses. Instead, their power has been limited by factors like competition with other self-interested entities, the need for labor and the need to avoid uprising \citep{mills1956power, olson1965logic, stigler1971theory, piketty2014capital, acemoglu2012nations, thompson1971moral}. Some of these constraints may weaken in the future \citep{drago2025defining}, as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably}, autonomous weapons concentrate control of lethal force in a small number of hands \citep{scharre2018army}, and the need for human labor decreases \citep{susskind2020world, ford2015rise}.
