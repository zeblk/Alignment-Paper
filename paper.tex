...
Now we look at the alignment problem through this lens. There is broad consensus that alignment means working toward healthy and flourishing futures. We therefore reason that alignment can be understood as the problem of maintaining creative sensitivity by continually contextualizing attachment to any particular form. An advantage of this perspective is that it is less bound to current conceptual frames which might change radically as intelligence increases and human-AI systems evolve. We accept that humans, other living systems and AI are all tightly interwoven and long-term flourishing must be at a systems level \citep{latour2012we, haraway2020staying, hayles2000we, bateson1972steps, folke2006resilience, douglas2012social}.

We begin Section 2 by casting a few established alignment problems -- perverse instantiation, failures of instruction following, inequality, loss of diversity and AI psychosis -- as special cases of overcommitment to particular forms. Then we highlight how our life-inspired framework is a generalization of these special cases. Finally, we make a case that this generalized version (i.e. the way life avoids overcommitment to maintain semi-stable, open-ended, difficult-to-formalize sensitivity) is indeed well-aligned with what we value most deeply. 
...
\subsection{The general version, going beyond the special cases}
