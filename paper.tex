...
The central ideas of this paper are necessarily abstract, as we hope they may contribute meaningfully to reasoning about AI even when it is vastly different from anything we are familiar with. To relate these abstract ideas to familiar things, we will walk through a series of examples from living systems. Within each example, we hope the ideas are approachable if not commonsense. Seeing how the same principles play out across a wide range of systems may also foreground their generality.


\subsection{Cell membranes and semi-permeable boundaries}
...
\subsection{Group problem solving and diversity}
...
\subsection{Genes and groundedness}
...
\subsection{Laws and evolving patchworks}
...
\subsection{Ecosystems and reciprocal limits}
...
\subsection{Interpersonal dynamics and domination}
...
\subsection{Motivation and long-sightedness}
...
\subsection{Contextualization and contemplative practice}
