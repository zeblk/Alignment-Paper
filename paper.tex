...
Now we turn this lens to the AI alignment problem. Our central thesis is that alignment means avoiding overcommitment to any particular form. In this section we first recast some well-studied AI safety and alignment problems\footnote{We prefer `alignment' as the broadest umbrella term to include `AI safety' and all other aspects of designing AI in a way that leads to positive futures.} in this language. We then use our framework to examine what is missing from the current research landscape. Finally, we investigate what a truly aligned future could look like.
...
This is overcommitment to the goals and interests of a few individuals, at the expense of others.
