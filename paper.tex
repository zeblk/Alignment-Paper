...
% We hope this lens might inspire more appreciation for the multi-perspective and ever-changing nature of life and remind us that any particular form of technology cannot be a final answer.
...
% Collapse or overcommitment can therefore be equivalently viewed as absence or failure of contextualization: over-identification with a myopic frame while missing a broader picture. 

% The cell's ability to copy itself is a vital function when regulated in a contextually-appropriate way.

% or a mass extinction initiates a new wave of evolutionary discovery. 
...
Sex is costly. An allogamous organism must find a mate in the vast and dangerous world, and in many sexual populations only half of the individuals can bear offspring and each individual loses half of its genetic representation in each offspring \citep{smith1971origin, lehtonen2012many, goodenough2014origins}. Yet nearly all eukaryotes reproduce sexually\footnote{And organisms with nonsexual reproductino often use mechanisms like horizontal gene to move genetic material across lineages, performing related functions.}
 \citep{speijer2015sex, bell1982masterpiece}. And among the creatures with both sexes in one organism (hermaphrodites), many go to great lengths to limit self-fertilization \citep{charlesworth2005plant, de1997incompatibility, jarne2006animals}. Why has evolution placed a barrier in the path to reproduction, and why isn't this onerous strategy outcompeted by self-fertilization or rapid asexual cloning \citep{smith1978evolution}?
...
% But we understand that AI shouldn't always comply with human wishes. If the user asks for something dangerous, we don't want the AI to comply. Slightly more subtly, if the user asks for something that might lead into a sycophancy loop \citep{dohnany2026technological} with the AI, we might also not want the AI to comply.
...
Humans have different interests, and AI is likely to be aligned to the interests of some humans more than others \citep{gabriel2025matter,sorensen2024roadmap,gabriel2020artificial, santurkar2023whose, baum2020social}. Additionally, advanced AI might confer substantial power to those who control it, with the possibility that a small number of humans will use control of AI to facilitate dominance over other humans. The latter possibility appears more likely as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably, hackenburg2025levers}, autonomous weapons place lethal force in a small number of hands \citep{scharre2018army}, surveillance and analytics improve, and the need for human labor decreases \citep{susskind2020world, ford2015rise, drago2025defining}. In either case---AI's unfairness or human power consolidation---extreme inequality runs a risk of collapsing society to the goals and interests of a few individuals. Of course, a world where everyone is identical would be another form of collapse. Distributing resources and power mitigates against collapse to the extent that it enables many diverse identities to thrive at multiple scales.

% Although it has been argued that inequality would not necessarily be misaligned in a future of extreme abundance, we view human inequality as a situation with high risk of being misaligned.
...
% todo: weilnhammer2026vulnerability will be a journal paper by the time we go to press
