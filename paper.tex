...
In this paper, we begin by studying a range of natural and human systems. We observe that each form -- an equation, a genome, a viewpoint, an institution -- is myopic in the sense that it is only a small aspect of the world. But the existence of many partial forms, developing rich, grounded individual identities while flexibly working together at many scales, constitutes the livingness of the world. Collapse is a failure mode where, instead of lightly-held dynamic relationships between different partialities, there is overcommitment to particular forms. Cancer spreads, concentrated power reduces human welfare, invasive species choke out complex ecosystems. In living systems, semi-permeable boundaries protect against collapse by maintaining distinctiveness of separate forms while also allowing them to interact productively. Boundaries thereby contextualize forms in relation to others, surfacing paradoxes by juxtaposing incompatible things. Boundaries underpin nuance and the continued arising of unexpected phenomena. 
...
The central ideas of this paper are necessarily abstract: we hope they may contribute to reasoning about AI even when it is vastly different from anything we are familiar with. To connect with these abstract ideas, we walk through a series of examples from living systems. Each example illustrates the core principle of the paper. In some examples we also drill deeper into subthemes that are especially vivid in that setting. Within each example, we hope the ideas are approachable if not commonsense. Seeing how the same patterns play out across a wide range of systems may also foreground their generality.
...
Boundaries encourage lightly-held, modular interactions. By not overcommitting to a particular genome, sex encourages genes to flexibly interact with other genes. Instead of being overfit to a particular context, genes develop a robust identity that's both independent and inter-functional. Recombination puts genes under pressure to evolve a generalized, grounded wisdom that reflects the deep structure of the world, like a person learning multiple languages and extracting the underlying commonalities. At the same time, because each gene is always working with other genes, it develops its own distinct point of view that adds unique value to a genome \citep{livnat2008mixability, livnat2010sex, wagner1996perspective}.
...
Again, as our ideas are tested against multiple situations and problems, they are refined and take on some of the deep structure of the world, a grounded wisdom.
...
An ecosystem's health and resilience depend on boundaries that limit the effectiveness of any constituent gene, organism, group or species \citep{holling1973resilience}. Each entity tries to consume resources and proliferate, but if it succeeds too thoroughly, the ecosystem suffers.
...
Compared to other animals, the human brain especially attempts to discretize its experience into approximately symbolic representations \citep{dehaene2022symbols, touretzky1988distributed, smolensky1990tensor, behrens2018cognitive}. The capacity to separate things into nearly-discrete entities and then recombine them in vast numbers of structured ways powers the extraordinary human capacity for reasoning \citep{fodor1975language, pinker1994language, lake2015human, chomsky1957syntactic, kurth2023replay}. Again, semi-permable boundaries keep forms distinct while enabling them to flexibly and modularly interact.

More broadly, healthy brain dynamics live at a sweet spot between excessively stable synchronized patterns and chaotic uncorrelated noise \citep{beggs2003neuronal, chialvo2010emergent, tognoli2014metastable, deco2011emerging, bak1987self, shew2011information, rabinovich2008transient, haldeman2005critical, kotler2025pathfinding}. In this regime, the brain has access to a huge repertoire of patterns that it can explore temporarily without overcommitting or getting stuck. Loss of dynamic flexibility, where the brain's activity becomes more stereotyped and no longer explores as wide a repertoire of states, is tied to lower cognitive performance \citep{garrett2013bold, grady2014understanding, cocchi2017criticality, muller2025critical, shew2009neuronal}. More extreme hypersynchrony leads to severe dysfunction. For example, in Parkinson's disease, basal ganglia and cortical circuits collapse into excess synchrony and lose the flexibility needed to guide nuanced motor outputs \citep{hammond2007pathological, brown2003rhythmic}. 
...
When nothing stops a myopic drive or goal or strategy from dominating behavior, it tends to achieve its aims through a shortest-path mechanism. The simple strategy of ``approach food" achieves its aims of moving toward the food, without accomplishing the deeper goal for which moving toward food is only a proxy. When the chicken runs directly toward the food, it spends energy without achieving the deeper goal. This energy is discharged or short-circuited. 

Boundaries, on the other hand, translate the pressure of motivation into higher-order structure -- the best way to approach the food is not the shortest path in the original conceptual space. Instead, achieving the goal depends on discovering a new solution. Again, semi-permeable boundaries support formation of new structure by placing contextualizing limits.
...
Awareness is contextualization \citep{yontef1993awareness}. Some forms exist in our minds without awareness. Think of an assumption somebody has about the world that has never been questioned. That assumption could be life-long and self-defining, or it could be fleeting and perceptual, like the assumption that the thing I'm touching is a keyboard. Unquestioned assumptions are overcommitment. We believe in them absolutely. But sometimes there's a moment of stepping back, where the assumed form becomes an object in awareness. In that moment, the assumption is contextualized. We realize it's not an absolute truth, but rather a form in our minds. 

Contemplative traditions suggest that the only `absolute' truth is the self-evident truth of immediate experience. Even the concepts that arise to describe the experience are relative and infinitely incomplete. This is naturally hard to think about. As soon as you get some idea about it, the idea is another partial form. Where is that form being held? And the word `truth' is of course fraught. We might alternatively describe it as something more like an orientation toward stepping back from each perspective into awareness. This itself is never-ending and non-formalizable, because what is the process of stepping back? By construction, contextualization is an unsolvable mystery. 

That orientation is an evolving system of boundaries. Awareness isn't one particular thing. It's the process of limiting overcommitment to any thing. What it takes to limit overcommitment to A is different than what it takes for B. New boundaries are needed as the situation changes. This will be relevant for AI alignment in the next section.

The boundaries of awareness are semi-permeable because they don't nullify or completely cut off the form they contextualize. Becoming aware of a belief doesn't make the belief wrong in an absolute sense any more than it was right in an absolute sense. 

Awareness holds us at the knife's edge of not collapsing exclusively into any particular forms. This enables a deeper sensitivity to ourselves and to the world. Subtler forms, which would have been erased by overcommitment to other forms, instead play a role in a richer overall internal structure. Our own potential within the world can creatively emerge, in continued newness. 
...
The desire not to collapse into particular concepts is familiar in art, poetry and music. The meaning of art is open-ended and changes with context -- it has an inner life. Likewise, most spiritual and contemplative traditions have a notion of truth as something that is alive and can't be frozen into a formalism. In fact, spiritual traditions often posit that suffering comes from over-attachment to particular conceptualizations or desires: from trying to formalize the world and believing excessively in that formalism. That means being attached to particular concepts, beliefs, feelings and other patterns in a collapsed way; becoming insensitive to the rest of reality. The part of the world not covered by our concepts subjectively appears terrifying or morally wrong.

It always feels like a surprise when we allow the unknown to happen. People often report that the energy locked in the darkness turns out to be full of life and positive energy, and that there's something self-evidently good or beautiful about participating in this mysterious discovery of new structure and relationship. There's a paradox because releasing into a larger context isn't something we can choose to do directly. Instead there's an “offer” at certain moments, right at the edge of the self. We might accept the offer because of something we believe or want, but fundamentally what we're getting isn't what we believe or want. If we accept the offer, then the release leads to a more subtle relationship with a larger context. Some traditions call this grace. It's not mysterious from a systems point of view, but it's intrinsically mysterious from a subjective point of view, because it's exactly what we don't currently understand. It means not rigidly accepting a false dilemma, the duality of my current categorization.
...
Some traditions also say that collapse is related to subjective suffering. Whatever our current collapsed pattern is, it exists because it has mechanisms that hold it in stasis. Instead of healthy barriers that sustain individuality while allowing flux and participation in new higher order structure, it has rigid barriers that don't allow this growth of subtlety (in fact it's often the lack of barrier at a higher level of organization that causes us to fall back on excessively rigid barriers at a more primitive level). In subjective terms, we're afraid of something we've axiomatically defined as bad. Because it's outside our self, by definition we can't picture exactly what it is. There's always something we believe in, something we can't even see as an object because it's so tautological for us. In this sense, collapse might be viewed as the opposite of spiritual health. In another sense, that collapse is always inevitably contextualized, and love has no opposite.

By giving ourselves what we think we want, we make the world more rarefied and homogeneous. We pretend that things are formalizable, in our own image. We become insensitive to the non-formalizable reality. 

These same dynamics happen throughout other living and non-living systems, but humans have it particularly rough because our imagination of an idealized world (equivalent to our implicit fear about it not being that way) includes our beliefs about ourselves. We apply our optimization machinery toward a detailed self-concept of how we should be, and especially how we should feel. If we feel bad, there's a tension between reality and our idealized image, which makes us feel even worse. 
...
Subjectively, participation in larger contexts is awareness. Most spiritual traditions have a form of prayer, meditation or other awareness practice. Our collapsed patterns resist change, holding the tension that paradoxically creates the unease they resist. But awareness contextualizes these dynamics so the fear or wrongness of not-self is no longer an absolute but instead exists in relationship. Awareness is a sensitive balance between many possible conceptualizations, held through nuanced boundaries. Thus, awareness brings healing and growth. 
...
We now apply our lens to the AI alignment problem. Our central message is that overcommitment to any particular form of AI means collapse, and AI carries a singular risk of overcommitment because of the extremities attached to it.
...
\textit{Even the concept of `values' is a form that we shouldn't over-index on.} This might sound circular and paradoxical -- that's because it is. Doesn't `should' imply values, but if so, doesn't that contradict the statement that we shouldn't overindex on values? It's a perfect example of how you get stuck with any particular forms.

\subsection{Extremeties of AI}

Many of these categories are overlapping with each other.

\textbf{Intelligence.} Intelligence has always been the thing that gives us the ability to control other technologies (and other species). For the first time, we're endowing something else with true intelligence. 

\textbf{Exceeding human abilities.} This creates a fundamentally new problem: it is difficult to control an agent more intelligent than ourselves. In some aspects it is already greater than our own (with potential for malware, misinformation, coercing humans, displacing intellectual labor, etc)

\textbf{Intensity of optimization toward an objective.} This is already happening. Vast resources. Data centers, energy, money, data.

Are there any examples of Harvey (law AI) proxy failure? Like the AI learns to find arguments that humans can't refute, even though they might be subtly wrong?

Or other examples of the intensity of optimization causing collapse in existing applications?

\textbf{Concentration of information flow and human attention.} So many people relying on chatbots now for answers. Instead of relying Google search on the internet which was (ideally) surfacing diverse content created and refined by many different individuals with different perspectives over a long time. (Counterargument: chatbots are just giving us a better view on the internet. They've memorized the whole thing.)

What about when this same concentration starts to happen with robots completing tasks? (Of course, that has already happened a lot in the world with industrial robots and even with human concepts leading to people doing the same things the same way all over the world.) Also, the same idea with agentic LLMs.

\textbf{Concentrating human power.} It is possible that a very small number of humans will have the majority of control over AI systems, which will give them greater dominance over other humans. Especially if the AI systems include robots that replace most human labor.

Historically, power of states, corporations and elite individuals has been limited by factors like competition with other self-interested entities, the need for labor and the need to avoid uprising \citep{mills1956power, olson1965logic, stigler1971theory, piketty2014capital, acemoglu2012nations, thompson1971moral}. These constraints are likely to weaken as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably}, autonomous weapons concentrate control of lethal force in a small number of hands \citep{scharre2018army}, and the need for human labor decreases \citep{susskind2020world, ford2015rise, drago2025defining}.

\textbf{Not being limited to biological substrate.} Speed, ability to self-copy and self-modify, share information between copies, take in vast sensor data, etc.

\textbf{Rate of change.} AI-powered algorithms already shape our behavior, yet rapidly changing technology outpaces regulatory response. Sora videos, for instance, are increasingly optimized to capture attention. In the future, advanced agents may act faster than human institutions or social processes can respond.

\textbf{Recursive improvement and runaway intelligence.} Finally, the greatest extremity is recursive self-improvement.  If AI approaches human-level intelligence, it will likely be able to improve itself at least as quickly. As AI then begins to exceed human intelligence, it may plausibly begin to improve itself even faster, creating a positive feedback loop and an intelligence explosion \citep{good1965speculations, vinge1993coming}. 

However, this intelligence explosion need not be aligned in any meaningful sense. Using Bostrom's classic example, imagine an AI whose sole objective is to maximize paperclip production \citep{bostrom2014superintelligence}. Plausibly, the system would continually work to improve its own intelligence and capabilities because it knows this is the best way to increase future paperclip production \citep{silver2021reward, bostrom2012superintelligent}. 


\subsection{Particular forms} 

What does it mean to overcommit to particular forms of AI? Let's take a simple and well-discussed example first. 

What would overcommitment to an objective function look like? Bostrom scenarios. 

What would it look like to be overcommitted to human values, even if learned dynamically? Super-fish intelligence.

What would it look like to be overcommitted to a particular mechanism for learning human values?

What would it look like to be overcommitted to particular representations within the model?

Training data, model architecture, trained model as an artefact, etc





To illustrate this idea, let's start with a dramatic example: the superintelligent paperclip maker \citep{bostrom2014superintelligence}. Nick Bostrom proposed a thought experiment where an AI has intellect and capabilities far beyond our own. It has been given the single goal of producing paperclips. If such an agent did everything it could to maximize its objective, it might well wrest control of the Earth from us and transform it entirely into a bleak paperclip factory. Superintelligence is an extremity that charges the narrow paperclip goal with overwhelming force, causing overcommitment to a particular form.

But goals don't have to be as narrow as `making paperclips' to be dangerous when charged with great force. Suppose the AI's objective is to improve the human subjective experience of wellbeing. Achieving this stated objective may be most efficiently achieved by imprisoning humans and directly stimulating neurons to trigger the experience of wellbeing \citep{bostrom2014superintelligence}. It is difficult or impossible to capture what we really value -- any specification of what we value is incomplete \citep{krakovna2020specification, russell2019human, grossman1986costs, hadfield2019incomplete, zhuang2020consequences, gabriel2020artificial, wiener1960some, amodei2016concrete}.

The problem is that \textit{being too good at any particular thing} means collapse. 


Also, the force doesn't have to be as great as superintelligence to cause overcommitment to particular forms.





For a large space of possible goals, the system could reasonably be expected to try to improve its own intelligence and capabilities, recognizing this as the best way to attain its goals more fully \citep{silver2021reward, bostrom2012superintelligent, omohundro2018basic}. 

But recursive self-improvement isn't the only extremity attached to AI. And the form does not need to be as caricatured as paperclip-making to be partial.
...
Recursive self-improvement. If AI begins to approach and exceed human-level general intelligence, it may accelerate its own development, creating a positive feedback loop and an intelligence explosion \citep{good1965speculations, vinge1993coming}.
...
It can outsmart us and adapt faster than we can respond.

If it is still fixed to a particular form, then it may do an extreme job of operating from the point of view. 

One example of a fixed form is a fixed value function or goal. Like paperclips or a more complex value function.

Even without superhuman intelligence, 

AI is also prone to milder forms of collapse. It tends to focus everyone in the world on relying on a particular conceptualization (the form of the trained model, which is similar between models because of similar architecture, similar training data etc). We all start to think in terms of the same concepts and the same solutions to things. 


Technologies have always had particular imperfect forms. By 1900, boiler explosions killed an estimated two people per day in North America \citep{cepforensic2021keeping}. Humans iterate on technology, doing our best today while knowing future generations will improve on our solutions. But AI may be different.

AI spending will reach an estimated 1.7\% of global GDP in 2026 \citep{gartner2025gartner}, rivaling the concentration of spending during the buildouts of electrification, railroads, and automobiles \citep{fogel1964railroads, nye1992electrifying}. The vast majority of this money is being poured into a very narrow set of ideas. Most companies use similar chips, similar model architectures, similar training data, and similar objective functions.



AI serves as a tool for concentrating power in few hands through propaganda, advertising, autonomous weapons, surveillance, policing, and control via analytics.
...
\section{Alignment, boundaries, contextualization}
...
So what does the opposite of this look like? In living systems, semi-permeable boundaries continunally contextualize partial forms to be more long-sighted and support increasing subtlety.
...
Super-fish intelligence. Following the principles of life, AI can continue to develop beautiful and meaningful new structure after it passes human level.
...
Attainable Utility Preservation \citep{turner2020conservative}. Relative reachability and impact measures \citep{krakovna2018penalizing}. Conservative agency.
...
\section{Failure modes for specifying values}
...
\section{Morality and normativity}
...
\section{Open-endedness versus optimization for an objective}
