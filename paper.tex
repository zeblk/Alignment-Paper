...
This pattern in biology mirrors the observation in computer science that excess attachment to the form of particular objectives is detrimental. 

`If we want to reach valuable destinations we have to be prepared to travel the road with no destination'
...
The life that exists today is exactly what has successfully traced a path through time along a knife edge of avoiding collapse into randomness or stasis. 
...
Across this section we look at a variety of examples of natural and human systems, and we see a common principle. These systems use an extraordinarily nuanced web of semi-permeable boundaries to allow individual forms to thrive without overcommitting to them.
