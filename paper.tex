...
Collapse or overcommitment can be equivalently viewed as absence or failure of contextualization: over-identification with a myopic frame while missing a broader picture. When a cell becomes cancerous, it loses the context of appropriate function within a tissue and instead recklessly executes its myopic vision. At a larger scale, a stock trader who sells irrationally in a panic follows the overly simplistic idea: ``the stock is crashing, get out!''. In excess attachment to this myopic frame, they miss the broader context---higher-order or longer-term aspects of the situation. Living systems function poorly when a myopic form runs amok without contextualization, overwhelming and collapsing the potent interplay of diverse parts. They function well when forms locally commit to their own identities but also participate in larger contexts. The stock trader's fear might be one signal of many, useful if held as part of a larger picture. Likewise, the cell's ability to copy itself is a vital function when regulated in a contextually-appropriate way.

At the same time, collapse is relative, and myopic frames are a necessary part of all living systems. Life's history is littered with collapses at all scales, from the death of a cell to mass extinction events. Every entity is myopic or partial: it does not capture everything else in the world. When the larger system is functioning well, local collapses are held in context. A cell's death clears the way for other needed growth, or a mass extinction initiates a new wave of evolutionary discovery.

% As a result, healthy living systems can be partially understood from many different perspectives.

% diverse myopic forms participate in subtle relationships with open-ended potential for future creation
...
3) The melioristic argument is that because it's easy to imagine concrete paths toward both the pessimistic and optimistic outcomes, it may be that both outcomes are indeed within the realm of possibility. In this case, our choices now matter immensely \citep{ord2020precipice}. 

We lean toward the melioristic position. It might also be argued that as long as there is any possibility it is true, we are obliged to act as if it were. If this is true, then continual effort toward invention will be required, first on the part of humans, and then increasingly on the part of AI or human-AI systems, to contextualize myopic forces. An aligned future will continue the living process of maintaining and enhancing the individuality of distinct elements while simultaneously deepening their relatedness---like how a species may over time acquire more distinctive features while also becoming a richer reflection of the world around it. Distinct elements will continue to experiment with their own solutions to the problems they face from their unique perspectives, expanding a broad reservoir of uniquely useful components that can be drawn on by larger systems that include those components. The universe will thrive on an open-ended trajectory of diversity, subtlety and potential. Every entity will always inevitably be myopic, but the world as a whole continues to unfold in a robust way because different perspectives exist to buffer each other's sharp edges. 

In humans, internal discovery is a central aspect of livingness. Even our most foundational personal assumptions are probably not final answers. At the sensitive edge between excess belief and excess disbelief, we sometimes step back to see the axiomatic thing in context. As AI systems gain agency and ability and become integral parts of social and psychological systems, internal discovery will also be an essential feature of AI and human-AI systems. Living AI systems will continually contextualize their own foundational assumptions as partial truths, participating in the open-ended process of life. 
