...
We suggest a new way to think about AI alignment: as a rich, ever-changing, imperfect array of semi-permeable boundaries that contextualize any particular forms. Contextualization nuances the functioning of systems, supporting the continued arising of unexpected phenomena. First we show how a range of living systems follow this principle, and then we apply the same idea to the problem of alignment.
\end{adjustwidth}
\vspace{30pt}
...
In this paper, we argue that true alignment is not achieved through any formalizable objective or principle. Any conceptualization is by itself inherently misaligned. Instead, alignment is the ongoing process of limiting overcommitment to any particular form.

To make this argument, we begin by studying a range of natural and human systems. We observe that each form -- an equation, a genome, a viewpoint, an institution -- is myopic in the sense that it is only a small aspect of the world. But the existence of many partial forms, developing rich, grounded individual identities while flexibly working together at many scales, constitutes the livingness of the world. Collapse is a failure mode where, instead of lightly-held dynamic relationships between different partialities, there is overcommitment to particular forms. Cancer spreads, concentrated power reduces human welfare, invasive species choke out complex ecosystems. Semi-permeable boundaries protect against collapse by maintaining distinctiveness of separate forms while also allowing them to interact productively. Juxtaposing incompatible things surfaces paradoxes and propels evolution. 

% semi-permeable boundaries contextualize myopic forms as part of larger systems. 

AI charges particular myopic forms with enormous leverage, creating a unique risk of overcommitment. If aspects of the AI system remain fixed while it gains increasing resource, capability and purview, there is a possibility of severe collapse. Some researchers believe AI is inevitably destructive for these reasons. We cautiously argue that there is a non-destructive path available, by reframing AI as a continuation of living processes that bound one another to support increasing subtlety of organization. Applying the template of living systems, we recast alignment as an evolving network of semi-permeable boundaries that contextualize any particular form of AI to avoid collapse and promote ongoing discovery of new structure. 
...
\section{Genes and groundedness}
...
\section{Laws and evolving patchworks}
...
\section{Art and spontaneous novelty}
...
\section{Ecosystems and reciprocal limits}
...
Limits within an ecosystem are often reciprocal. Deacon has the idea that constraints reciprocally limit processes and give rise to life and consciousness \citep{deacon2012incomplete}. He talks about it mostly at a molecular level.
...
\section{Interpersonal dynamics and domination}
...
\section{Motivation and long-sightedness}
...
\section{Contextualization and contemplative practice}
...
Awareness is a semi-permeable boundary. 
...
Sensitivity as a delicate balance between a lot of concepts. By being at the knife edge and not collapsing into one interpretation, we allow something greater than the self to operate.
...
At the core, sadness (loss) and love can't be separated. Or life and death. Within an individual, there's a flux between holding on to what we believe in and releasing into a broader truth. But they're not at odds, they work together. This is healthy boundaries -- holding some structure while allowing relationship and continuing newness. A `part' is nested within a larger context. 
