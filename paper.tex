...
Now we turn this lens to the AI alignment problem. Our central thesis is that alignment means avoiding overcommitment to any particular form. The problem is particularly challenging because AI carries extremities that create a danger of severe overcommitment. In this section we discuss those extremities, what is missing from existing mitigation approaches, and finally what an aligned future could look like.
...
AI is a unique technology. Traditionally, humans have been empowered by our own intelligence to maintain a degree of control over other systems and technologies. For the first time, we're now endowing non-human agents with intelligence that could exceed our own -- with the risk that we lose control. In some ways, AI is already superhuman. It can copy itself almost instantly, run on upgraded hardware, communicate with other instances of itself at high bandwidth, and read vast data. By virtue of its non-biological substrate, it has the potential to learn, change and adapt many times faster than humans. If AI approaches human-level intelligence, it may begin to improve itself in a recursive cycle, creating a positive feedback loop and a rapid intelligence explosion \citep{good1965speculations, vinge1993coming}. There is good reason to think it will be motivated to do so: for many goals, first improving oneself is a rational means toward achieving the final goal \citep{silver2021reward, bostrom2012superintelligent, omohundro2018basic, turner2019optimal}. For similar reasons, a superintelligent agent might (successfully) resist human efforts to alter its goals \citep{bostrom2014superintelligence,russell2019human}.

Presently, AI systems lag far behind humans in some crucial domains of intelligence. But even in the era of jagged intelligence \citep{karpathy2024jagged}, there are other extremities worth tracking. AI amplifies the trend toward centralization of information flow. As of October 2025, ChatGPT alone had 800 million weekly active users \citep{techcrunch2025sam}, and global AI usage continues to grow rapidly. At the same time, AI spending will reach an estimated 1.7\% of global GDP in 2026 \citep{gartner2025gartner}, rivaling the concentration of spending during the buildouts of electrification, railroads, and automobiles \citep{fogel1964railroads, nye1992electrifying}. A frontier training run expends hundreds of gigawatt hours of electricity and hundreds of millions of dollars to push trillions of numbers in a coherent direction defined by a formal objective. 

AI may also be a tool for concentration of human power. In some scenarios, a small number of humans will have the majority of control over AI systems, facilitating dominance over other humans. These scenarios appear more likely as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably}, autonomous weapons place lethal force in a small number of hands \citep{scharre2018army}, surveillance and analytics improve, and the need for human labor decreases \citep{susskind2020world, ford2015rise, drago2025defining}. 

\subsection{What is missing from mitigation approaches}

All of the risks mentioned above are studied extensively.

Global governance with democratic oversight, verification mechanisms, etc \citep{bostrom2014superintelligence, dafoe2018ai}. Binding agreement for AI companies to distribute capital to the public \citep{okeefe2020windfall}. Participatory AI \citep{birhane2022power}. Sociotechnical \citep{selbst2019fairness}. Inequality research.

* Solutions to concentration of information and `mode collapse' of human thought.

* Solutions to rapid self-improvement. Such as placing limits on the capabilities of the system.

* Solutions to overcommitment to particular values. Corrigibility, uncertainty, constitutional AI. 

All of these are valuable. But no formal approach by itself is alignment. Sticking to any of these approaches is not aligned.
