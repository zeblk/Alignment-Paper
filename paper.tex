...
Boundaries, collapse and contextualization are abstract ideas. To show more clearly what we mean, we will walk through a series of examples from living systems. Within each example, the ideas are commonsense and straightforward. Our hope is that working through multiple examples foregrounds how general and fundamental the concepts are.
