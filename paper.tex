...
A key point, which we'll return to several times, is that undercommitment is also overcommitment. Undercommitment is the simple form of homogeneity. It's essential that we do locally commit to forms -- while preserving the flexibility of contextualization at a larger scale. The problem arises when a particular goal or mental process runs amok without being contextualized in a larger framework. 
...
We often frame life as a system that staves off entropy, and it is tempting to imagine life as something that sits complacently in stability. It is less obvious that living, the fight for stability, is only possible if you are made of something unstable. Life is as magnificently fragile as it is ordered. Balancing the fine line as a fragile assembly within a highly dynamic world is an active process. Through the unbroken history of life, entities fell off either side, erased by heat or frozen in time.  What we see living now is what traced a path exactly along the edge.

Each lifeform we see today is a continuation of background momentum, building up from simpler but already incredibly rich processes which are themselves exquisitely contextualized to their surroundings. Billions of interactions over time have shaped living things on every scale to have traces of the systems they interacted with. Lifeforms have been faced with an incomprehensibly vast number of kinds of problems and explored combinatorially many partial solutions -- within a cell, within an organism, across a population. 

The answers get imprinted into a million different dimensions. While our conscious concepts fit the world at one level, unconscious processing shapes much of our behavior, the anatomy of our bodies encodes another kind of intelligence, our enzymes fit the world at a smaller scale, and in an evolvability sense our genes anticipate future selection challenges.
