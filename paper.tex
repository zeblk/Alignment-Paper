...
Living systems generate new descriptions as they evolve (Stuart Kauffman). There's this edge-of-chaos process, but interestingly it's more than anything that can be understood from any given perspective, because it keeps generating new things that require fundamentally new kinds of description.
...
We begin Section 2 by casting a few well-studied alignment problems -- the Midas problem, failures of instruction following, inequality, loss of diversity and AI psychosis -- as special cases of overcommitment to particular forms. Then we highlight how our life-inspired framework is a generalization of these special cases. Finally, we make a case that this generalized version (i.e. the way life avoids overcommitment to maintain semi-stable, open-ended, difficult-to-formalize sensitivity) is indeed well-aligned with what we value most deeply. 
