...
Now we shift gears. Across a number of living systems, we've outlined how boundaries place selective limits on interactions so that, instead of overcommitting to a particular form, systems maintain a delicate balance between distinctive parts that work flexibly together. With these intelligent protections, new structure continues to contextualize previous partialities. In the remaining sections, we apply this lens to the AI alignment problem. 

Our central message is that overcommitment to \textit{any particular form of AI} means collapse, and AI carries a \textit{singular risk of overcommitment} because of the extremities attached to it. We examine these two elements in sequence.

\subsection{Overcommitment to particular forms of AI} 

What would overcommitment to an objective function look like?

What would it look like to be overcommitted to human values, even if learned dynamically?
...
\subsection{A singular risk of overcommitment} 

The amount of resource concentrated in one place, the potential for self-improvement, the possibility that it will surpass our own understanding and capabilities.
...
A point I need to talk more about: as agents grow more capable, overcommitment to forms (e.g., narrow objective optimization) can drive more catastrophic collapse. What do examples of this look like?
...
Sort of like the Founding Fathers writing the Constitution with its self-modifying ability.

We want to set this future system, which is way out of their control, in a good direction. A direction where, not only does it not collapse into paperclips, but someone in the future who far transcends our understanding and morals will be pleased with it. 
...
Q: It's nothing new to say, `we'll always keep iterating on solutions'. 

A: With previous problems, humanity did our best to find solutions with the understanding that future generations would have new tools available and would iterate on our solutions. AI is different. 
