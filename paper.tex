...
Or, it could go the other way. Some researchers have proposed that because roughly the same AI technology is available to the poor and unskilled as it is to the wealthy and skilled, AI will have a `leveling' effect \citep{noy2023experimental, brynjolfsson2025generative}. In this model, most people will have access to a similar level of intelligence and empowerment, with AI democratizing access to knowledge, reasoning and leveraged action. This is a cause for cautious optimism, which we discuss in Section \ref{sec:toward}.
...
However, it is worth noting that none of the studies cited here made a best effort attempt to use AI systems in a thoughtful way to increase rather than decrease diversity. This also gives hope, which we again return to in Section \ref{sec:toward}.
...
Having explored misalignment from the standpoint of life, we now ask what a positively aligned future might look like and how we can achieve it. 

The use of boundaries against collapse in technology is as old as technology. As soon as we started building things, we had to build in boundaries, because we want the things we build to be more robust and less dangerous. We put circuit breakers in the power grid, governors in steam engines, escapements in clocks. In AI research we apply safety methods like safety post-training, guardrail models, red teaming, ongoing evaluation and monitoring. We try to improve our mechanistic understanding of AI systems so we can detect and correct hidden flaws \citep{olah2020zoom, burns2022discovering, bereska2024mechanistic, anthropic2024mapping}. Fair principles for AI have been proposed to prevent over-reach of any party \citep{gabriel2025matter}. Governments apply oversight to anticipate and mitigate risks of AI technology to human rights and national security \citep{eu2024aiact, uk2023bletchley, us2023eo14110}. 

Arguably, many methods used to improve performance of AI systems are also mechanisms to support partial independence of functional units within those systems. For example, modern LLMs use mixtures of experts, routing information selectively to areas that specialize in the right kind of computation. It has been argued that dropout serves a role analogous to sexual reproduction: preventing units within a network from becoming overly co-adapted \citep{srivastava2014dropout}. At a larger scale, partitioning systems into multiple agents can improve optimization \citep{jaderberg2019human}. Personalization or specialization of models, including through in-context learning and access to user data, create distinct model behavior, and it is likely the the internet in the near future will host multitudes of distinct agents interacting -- which carries its own risks \citep{hammond2025multi}.

Ideally, we will be able to continue the journey of life to build in adaptive boundaries as needed to contextualize 

preserve and nurture diversity at a social level. Labs explore different research approaches, nations have different cultures and strategic interests, ideas area drawn from diverse fields like neuroscience and physics. 

How can we use AI in a way that does not lead to domination of individual perspectives? 

One perhaps underexplored question is how to preserve and enhance diversity in human culture and concepts, at scales anywhere from national or ethnic groups to individuals, while productively putting the diverse elements in contact with each other. In recent decades, information exchange has enormously increased with telecommunications, the internet, and now AI itself. Because we can now use AI to effectively get answers from the rest of humanity instantly, an important aspect of this question is how we will structure our own use of AI to maintain our autonomy and diversity. (can refer back to the collapses described in `problem solving in groups' and `conceptual monoculture')
...
We might want to distinguish `concentration of power in the hands of elites' versus `collapse of global thought diversity without anyone necessarily benefitting'. Policies and regulations. Education, making sure everyone gets good at utilizing what is available.

All of these methods are *semi-permeable* and therefore contextualizing.
...
[relationship to `empowerment'-type alignment theories. maximizing affordances in the future or something like that.]


In living systems, evolving semi-permeable boundaries contextualize partial forms to be more long-sighted in time and space, increasing subtlety and potential. 

If we attach too strongly to any conceptualization of what we mean by `avoiding overcommitment' or `life-like evolution', then an AI system could masquarade as life-like without truly being so.
