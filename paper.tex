...
% *Equal Contribution
% Nenad Tomasev, Iason Gabriel, Joel Leibo, Verena Rieser, Marc Guitart-Masip
% }
% }
...
The boundaries of life embody a degree of nuance that's hard to fully appreciate. Life is as fragile as it is stable, and what exists today has traced a path through billions of years along a knife edge of avoiding collapse into randomness or stasis. The patterns of biological life ride a wave of semi-stable processes which are themselves exquisitely contextualized to their surroundings: nuclear physics, chemistry, nebulae, plate tectonics, tides, volcanism, magnetism, mineral cycles, water cycles, prebiotic chemistry \citep{smith2016origin, hazen2010mineral, stern2024importance, nisbet2001habitat, sleep2010hadean, baross1985submarine, wachtershauser1988before, martin2008hydrothermal, frank2024find, bregman2020humankind, virgo2011elongation, nowak2008prevolutionary}. On top of those processes, nucleotide replicators spawned a spectacular kaleidoscope of forms interrelated through shared heritage, ecological interactions and facing the same world. Through innumerable interactions, living forms have become fractally complex with traces of the rest of the world's static and dynamic patterns imprinted on each part. Each facet of living systems is grounded to the rest of reality in its own way, and together they admit endlessly many useful approximations -- different perspectives with different domains of validity. 
...
In summary, alignment is not picking the right values or principles, or even the right system for learning them. It is not any method for interpretability or keeping humans in the loop. All of these can be useful parts of alignment. But alignment itself is the continued dance of contextualizing any particular form, creating deeper relationship with the rest of the world. In this way, AI can support intense flourishing of life even far beyond current human conceptualization. 
