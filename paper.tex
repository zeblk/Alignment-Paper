...
The world has many kinds of organization or regularity, but none of these forms is an absolute, and no description captures everything. For example, the cells of animals are more or less organized into organisms. DNA is often transcribed into RNA. Arctic Terns, on average, migrate between northern and southern parts of the globe. The pencil is on the table. Any of these patterns individually is only a partial aspect of reality. 
...
To start to think about an answer to the big problem, let's look at how life stays light and full of potential despite the constant risk of collapse into one overcommitment or another. The central principle is that natural and human systems use semi-permeable boundaries to support the individuality of forms while also holding them as partial in a larger context. Boundaries contextualize forms by preserving distinctness while enabling selective interaction, so the system flexibly accommodates partial perspectives rather than locking in a single story of what matters. 

Life is both the contextualizer and the thing being contextualized. In this section we'll first give a brief nod to the awesome intricacy of living systems. We'll then go through several detailed examples of how life contextualizes particular forms with semi-permeable boundaries to limit overcommitment. Each example illustrates the core principle; in some instances we also drill deeper into subthemes especially vivid in that setting. We hope that within each example the ideas are approachable if not commonsense and that tracking the same patterns across systems foregrounds their generality. Having developed these ideas, in Section 4 we will apply them to the AI alignment problem.

\subsection{The depth of life}

In the following subsections, we will look at examples of aspects of life contextualizing other aspects -- like cognitive control allowing a particular impulse to exist usefully as a flexible part of the organism's whole motivation. In those sections, we will zoom in on details of the particular examples. But we don't want to lose sight of the big picture, so in this subsection we briefly take a zoomed out view.

% of the involute filigree of life

Life is as magnificently fragile and ephemeral as it is ordered and stable. Through innumerable interactions over billions of years, it has become fractally complex with traces of the rest of the world's static and dynamic patterns imprinted on each part. Each lifeform we see today is a continuation of background momentum, building up from a world-deep wave of semi-stable processes which are themselves exquisitely contextualized to their surroundings: nuclear physics, chemistry, nebulae, plate tectonics, tides, volcanism, magnetism, mineral cycles, water cycles, prebiotic chemistry \citep{smith2016origin, hazen2010mineral, stern2024importance, nisbet2001habitat, sleep2010hadean, baross1985submarine, wachtershauser1988before, martin2008hydrothermal, frank2024find, bregman2020humankind, virgo2011elongation, nowak2008prevolutionary}. On top of these processes, nucleotide replicators spawned a spectacular kaleidoscope of forms interrelated through shared heritage, ecological interactions and facing the same world. 

Each facet of living systems is grounded to the rest of reality in its own way, and together they admit endlessly many useful approximations -- different perspectives with different domains of validity. This is why the boundaries of life are so effective. They capture an immense amount of nuance from millions of historical interactions which themselves occurred under the constraints of the real world.
