...
In the following sections, we use examples from natural and human systems to illustrate how semi-permeable boundaries place intelligent constraints that limit collapse. Applying this template, we recast alignment as an evolving network of semi-permeable boundaries that contextualize any particular form of AI to avoid collapse and promote ongoing discovery of new structure. 
