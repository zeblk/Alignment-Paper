...
Institutions---constitutions, laws, norms, courts, regulators and so on---form boundaries against dominance of any actor's motives \citep{north1990institutions}. A business tries to maximize its success, but property rights, liability rules, and regulatory institutions constrain exploitation, deception, and anti-competitive practice. A political faction seeks to impose its agenda, but its power is limited by democratic procedures, constitutional limits, and checks and balances. Healthy societies depend on a multifaceted array of institutions at multiple scales \citep{ostrom1990governing, leibo2025societal}.
...
Intelligent agents do not necessarily accept boundaries set on their desires. Institutions must adapt as loopholes are discovered. Like other systems in the living world, they form an evolving network of boundaries \citep{campbell1979assessing, ordonez2009goals, kerr1975folly, burns2006impact} and can gradually acquire grounded wisdom as they are tested against many different situations and motives.
...
Perverse instantiation is a foundational problem in AI safety---the problem that an AI system might do what we say, rather than what we mean. For example, if we ask a superpowerful AI to increase human happiness and it literally complies, it might lock us all up and stimulate our happiness neurons. 

Unlike that dramatized example, modern AI systems don't rely on concise specification of a single objective. Instead, they build in many layers of detail about human preferences through post-training, prompting, safety filters and so on. In practice, this keeps the systems behaving reasonably much of the time, although there are still dramatic failures. But there's a widely-recognized danger that even with our intentions expressed in great detail, the expression may still deviate from what we really mean \citep{amodei2016concrete,gabriel2020artificial,russell2019human,bostrom2014superintelligence, krakovna2020specification, grossman1986costs, hadfield2019incomplete, zhuang2020consequences, wiener1960some}. The negative consequences of deviations are expected to worsen as AI systems continue to work more autonomously, especially if they work faster than humans can follow and in more complex ways than humans can understand. It may become more difficult to correct deviations, and the deviations can have more profound consequences.

Perverse instantiation is a collapse to the myopic form of a particular way of specifying our values. It is insensitive both to existing structure it does not capture (such as things we mean but don't say) and to new things that will come into existence in the future.
...
Instruction following failure is, in some cases, misaligned. The user asks an AI chatbot to write a poem about an elephant, and the AI instead writes a poem about a giraffe. What drives this kind of error? The model might have over-relied on `shortcuts' based on superficial correlations (even a single keyword) \citep{geirhos2020shortcut}, missing the user's actual intent, especially if the intent was not expressed in the most straightforward way. During training, the model might have gotten fixated on data that was overrepresented \citep{zhao2021calibrate,reynolds2021prompt,xu2024knowledge}. It could be, especially if the total context was long, that the model didn't flexibly attend to the correct positions in the input \citep{liu2024lost}. These kinds of instruction following failures reflect collapse of sensitivity to larger context, instead over-indexing on myopic patterns.
...
Humans have different interests, and AI is likely to be aligned to the interests of some humans more than others \citep{gabriel2025matter,sorensen2024roadmap,gabriel2020artificial, santurkar2023whose, baum2020social}. Additionally, advanced AI might confer substantial power to those who control it. In some scenarios, a small number of humans will have the majority of control over AI systems, facilitating dominance over other humans. These scenarios appear more likely as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably, hackenburg2025levers}, autonomous weapons place lethal force in a small number of hands \citep{scharre2018army}, surveillance and analytics improve, and the need for human labor decreases \citep{susskind2020world, ford2015rise, drago2025defining}. In either case---AI's unfairness or human power consolidation---inequality collapses to the goals and interests of a few individuals at the expense of others\footnote{Although it has been argued that inequality would not necessarily be misaligned in a future of extreme abundance, we nevertheless view human inequality as a situation with high risk of being misaligned.}. Of course, if everyone were identical this would be another form of collapse. Distributing resources and power mitigates against collapse to the extent that it enables many diverse identities to thrive at multiple scales.
...
% Why do we need a new framework for alignment? Isn't alignment basically just the problem of articulating human values and then getting machines to optimize for them?  No, because 1) perverse instantiation, 2) humans don't agree on values, 3) human values will keep changing, and humans ourselves will keep changing, eventually there won't be humans at all.
...
We thank Clark Potter, Iason Gabriel, Zach Duer, Andy Savoy, Paul Krueger and Sean Wilkinson for insightful discussions, contributions to earlier drafts, inspiration and advice.
