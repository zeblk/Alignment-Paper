...
The idea is familiar in philosophy. (Heidegger, William James, Ludwig Wittgenstein, Maurice Merleau-Ponty, Hilary Putnam, Isaiah Berlin, Iris Murdoch, Jakob von Uexküll) -- also cite religious philosophy. which texts make this point most directly?

To be clear, it's not easy to access what we really value. [how should we split the material between this section and the `perverse instantiation' section, which also goes through the ways that shallow human values don't capture everything we care about??]
