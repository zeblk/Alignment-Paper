...
The world has many kinds of organization or regularity, but none of these forms is an absolute, and no description captures everything. For example, the cells of animals are more or less organized into organisms. DNA is often transcribed into RNA. Arctic Terns, on average, migrate between northern and southern parts of the globe. Any of these patterns individually is only a partial aspect of reality. 
...
Life is as magnificently fragile and ephemeral as it is ordered and stable. Through innumerable interactions and grounded experiments over billions of years, biological life has become fractally complex with traces of the rest of the world imprinted on each part. 

Each lifeform we see today is a continuation of background momentum, building up from simpler but already incredibly rich processes which are themselves exquisitely contextualized to their surroundings. Life rides a world-deep wave of semi-stable dynamics: nuclear physics, chemistry, nebulae, plate tectonics, tides, volcanism, magnetism, mineral cycles, water cycles, prebiotic chemistry and so on formed the foundation for the layer of dynamics we call life \citep{smith2016origin, hazen2010mineral, stern2024importance, nisbet2001habitat, sleep2010hadean, baross1985submarine, wachtershauser1988before, martin2008hydrothermal, frank2024find, bregman2020humankind, virgo2011elongation, nowak2008prevolutionary}. In other words, evolution is the process that gives rise to life, not something that happens after life exists \citep{aguerayarcas2024computational, wong2023roles, vasas2012evolution}. 

And after the start of nucleotide replicators, things really went crazy. This is some context for the following sections, where we look at aspects of life bounding other aspects. If a boundary is itself formal, it's not much of a boundary. The effective boundaries are the ones grounded in the full depth of life.
...
% Sexual reproduction improves the capacity of a lineage to adapt better in the future. Selection itself cannot see into the future: it only sees, retrospectively, what worked and what didn't. But over time, it tends to discover generalizable mechanisms that act like they have some foresight or optimization ability of their own. In evolutionary biology this is called evolution of evolvability \citep{wagner1996complex, kirschner1998evolvability, valiant2009evolvability}. It has been proposed that evolution of evolvability is equivalent to the phenomenon called `meta-learning' in psychology and machine learning \citep{gajewski2019evolvability, wagner1996perspective, olah2021analogies, watson2016can}. In meta-learning, an outer loop of blind optimization (analogous to evolution) tends to produce more thoughtful internal learning algorithms automatically \citep{wang2018prefrontal, thrun1998learning, harlow1949formation}. If we take this analogy seriously, then it is reasonable to think of a genome itself as encodes a rich learning model of the world. In a sense, this is obvious, since the genome codes for the brain. But it may be true on many other levels as well.
...
As humans -- whether AI researchers or any participants in social systems -- this can be a mundane practical process of holding ideas with some skepticism, having patience to look at different timescales, listening to an internal voice of wisdom, entertaining conflicting perspectives. It can also be a profound process of self-awareness and personal growth. 
...
Reply: There is a possibility for extraordinary flourishing of life with AI as an important part of the picture. Tech can create new niches and proliferation of structure. The way humans are right now surely isn't the end of evolution in the universe. That said, 

Objection: Is this Luddism? You're talking about patience and constraints on technology.

Reply: There's a possibility for disaster due to things moving too quickly, collapse of diversity, loss of groundedness. Ultimately we don't think tech is inherently good or bad, and the kind of AI we're building now may or may not be part of an aligned path. Whatever direction society takes with more or less rapid advances, we hope the principles in this paper will be relevant.
