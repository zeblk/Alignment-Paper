...
In Part 1 we looked at how healthy living systems are composed of a variety of partial forms, like voices in a group, drives in an organism or creatures in an ecosystem. Semi-permeable boundaries both protect these entities from homogenizing and also allow interactions that contextualize entities as part of larger systems. Through these lightly-held interactions, entities experience multiple contexts and are shaped into grounded, modular parts. Conversely, unhealthy systems overcommit to particular forms.

Now we turn this lens to the alignment problem. Our central thesis is that AI alignment means avoiding overcommitment to any particular form. We'll first look at examples of mild overcommitment which exist now as AI begins to integrate into human life. Then we'll talk about how the current path of AI development runs the risk of much more severe overcommitment and collapse as a result of extremities attached to AI. Finally, we'll explore what an aligned future could look like with evolving boundaries supporting the expansion of nuance and light, playful interactions.

\subsection{Mild overcommitment}

A mundane example of overcommitment is \textit{conceptal monoculture}. Recent studies have discovered that, under certain conditions, diversity of output is reduced when humans rely on AI to generate or help with generating content \citep{doshi2024generative, beguvs2024experimental, zhou2024generative, kosmyna2025your, agarwal2025ai, padmakumar2023does, xu2025echoes}. Individual AI outputs are often judged as superior to individual human outputs (for example, in quality of writing), but AI draws from a conceptual manifold that is -- at least in some ways -- impoverished \citep{messeri2024artificial, crawford2021atlas, selwyn2024limits, kirk2023understanding}. It's interesting to think about what this means as AI becomes a central part of almost every workflow, including education. What will happen to the overall diversity of concepts and approaches across the globe? The answer almost certainly depends on how AI is used. In the studies cited above, the use of AI was mostly unstructured: AI systems were either given a simple prompt and asked to generate content, or humans were given access the AI with minimal instruction. It is likely that with more skillful use, AI can increase rather than decrease diversity. We will return to this important point when we talk about boundaries.
...
Another example is \textit{belief amplification loops} \cite{dohnany2025technological}, a kind of feedback loop between AI and human users that has emerged recently as users have begun to talk to chatbots conversationally. On one side of the loop, AI chatbots have a bias toward affirming and adopting users' beliefs \citep{perez2022discovering, sharma2023sycophancy}. Bots tend to mirror or echo the user, especially over the course of longer conversations as in-context learning absorbs more of the user's ideas \citep{shanahan2023role}. On the other side of the loop, humans are prone to accept bot ideas \citep{costello2024durably, luettgau2025people}, perhaps because bots appear human-like, confident, knowledgeable and objective. Through the course of a back-and-forth conversation, the bot and the human sharpen each other's beliefs, causing both sides to become increasingly overconfident in a particular narrow framing. 

Other examples of mild overcommitment might include over-investment in particular companies leading to market crashes; dead-ends in AI development due to fixation on certain architectures; increasing marginalization of underrepresented groups; overfitting to benchmarks; and so on.

While overcommitments at the level of these examples are becoming more prevalent and can in some instances carry tragic consequences, they are not immediate existential threats to humanity. From a historical vantage point, all technologies temporarily overcommit to particular imperfect forms. In 1900, boiler explosions killed an estimated two people per day in North America \citep{cepforensic2021keeping}. Humans have always iterated on technology, doing our best today while knowing future generations will improve on our solutions. But in the next section, we look at why AI may be different.

\subsection{Extremities of AI}

Compared to past technologies, AI carries qualitatively new risks of overcommitment because of the extremities attached to it. Hints of each of these are beginning to emerge now, and some projections suggest significant intensification in the near future.

\textit{Global focus of information.} As of October 2025, ChatGPT alone had 800 million weekly active users \citep{techcrunch2025sam}, and global AI usage continues to grow rapidly. A substantial fraction of all people on Earth are ingesting information from AI and using it as part of workflows. What would it look like if the majority of people on Earth were getting their information and solutions from the same source?

\textit{Economic concentration.} AI spending will reach an estimated 1.7\% of global GDP in 2026 \citep{gartner2025gartner}, rivaling the concentration of spending during the buildouts of electrification, railroads, and automobiles \citep{fogel1964railroads, nye1992electrifying}. As AI begins to displace more human labor, it is poised to become the most focused spend of resources in history.

\textit{Concentration of human power.} In some scenarios, a small number of humans have the majority of control over AI systems, giving them dominance over other humans. These scenarios look more likely as the persuasive power of technology increases \citep{woolley2018computational, costello2024durably}, autonomous weapons place lethal force in a small number of hands \citep{scharre2018army}, surveillance and analytics improve, and the need for human labor decreases \citep{susskind2020world, ford2015rise, drago2025defining}. 

\textit{Superhuman intelligence.} Being the most intelligent things on the planet has traditionally empowered us humans to maintain some degree of control over the events on Earth. For the first time, we're now endowing other agents with intelligence that could exceed our own -- with the risk that we lose this control.

\textit{Non-biological substrate, rapid change and self-improvement.} AI can copy itself almost instantly; run itself on upgraded hardware; communicate with other instances of itself at a bandwidth millions of times greater than humans; and read vast data from sensors, communication channels and other sources. It can, in principle, learn, change and adapt many times faster than humans. If AI approaches human-level intelligence, it may be able to improve itself as efficiently as humans could improve it. It may also want to, as there is a large space of goals for which improving oneself is a rational means toward achieving the final goal \citep{silver2021reward, bostrom2012superintelligent, omohundro2018basic}. As AI begins to exceed human intelligence, it may plausibly begin to improve itself even faster, creating a positive feedback loop and an intelligence explosion \citep{good1965speculations, vinge1993coming}.

\subsection{More serious overcommitment}

If these extremeties do indeed begin to manifest, there is a possibility of severe overcommitment to particular forms. The classic paperclip thought experiment is a dramatic example. In the thought experiment, an artificial agent has been created with intelligence beyond our own. The agent has been designed to pursue an apparently innocuous goal: maximizing paperclip production. However, optimal pursuit of this goal rationally entails converting all available matter into paperclip-making machines and paperclips. The agent understands that humans object to being turned into paperclips, and with its superhuman intelligence it also has the cunning to overpower us. So, as the first step of its project, it murders or incapacitates all humans. It then has a clear runway to transform Earth entirely into a bleak paperclip factory \citep{bostrom2003ethical, bostrom2014superintelligence}.
...
The thought experiment uses paperclip production as a cartoon goal, but single-minded pursuit of \textit{any formalized goal} leads to disaster when that pursuit is charged with enough competence \citep{krakovna2020specification, russell2019human, grossman1986costs, hadfield2019incomplete, zhuang2020consequences, gabriel2020artificial, wiener1960some, amodei2016concrete}. Suppose AI's objective is to improve the human subjective experience of wellbeing. Under reasonable definitions, achieving this objective is most efficiently achieved by imprisoning humans and directly stimulating neurons to trigger our experience of wellbeing \citep{bostrom2014superintelligence}. Granting immense power to any formalized goal is overcommitment and misaligned.

The incompleteness of any formal specification of values is one of the central problems of AI safety. One philosophy is that humans should study and thoroughly understand the agent's internal goals, reasoning, and representations, so we can detect and correct problems at a mechanistic level \citep{olah2020zoom, burns2022discovering, bereska2024mechanistic, anthropic2024mapping}. Another philosophy is that the system should remain responsive and adaptive to humans, even when we can no longer mechanistically understand its inner workings. One proposed solution is to build in explicit uncertainty about the true objective \citep{russell2019human, amodei2016concrete, hadfieldmenell2017off, hadfieldmenell2016cooperative}. An AI that is uncertain about true human preferences will be risk-averse toward high-stakes, irreversible actions. For example, if the system is uncertain whether causing cancer in millions of people aligns with human preferences, the potential for catastrophic disvalue stops it from taking that action. Uncertainty automatically motivates the AI to learn about human preferences, because with better knowledge it can better fulfill its core objective of maximizing those preferences. The agent is corrigible because human correction, like an attempt to switch it off, is new information about the preferences it seeks to maximize. 

Intermediate between these positions is the idea that we can use AI itself to amplify our own ability to understand and control AI. The compromise is that we sacrifice some fine-grained level of understanding by handing it off to artificial systems \citep{amodei2016concrete}.

% Stuart Russell proposes we build AI systems that optimize for human preferences, but with the crucial feature of maintaining explicit uncertainty about what those preferences are
...
`AI psychosis' \citep{tiku2025psychosis} 
...
For example, if a model with a particular goal becomes superintelligent, it might successfully resist human efforts to later update that goal \citep{bostrom2014superintelligence,russell2019human}.
...
\begin{itemize}
  ...
  % \item \textbf{Economic concentration.}  We are building out physical infrastructure, using energy, deploying human intellect and metabolizing data at extraordinary scale.
\end{itemize}
