...
Mechanistically, to avoid collapse into randomness or regularity, living systems rely on an extraordinary, many-scale network of semi-permeable boundaries. Semi-permeable boundaries contextualize entities as part of larger systems by allowing them to interact without one part dominating or the system blending to homogeneity---either of which would mean collapse to a form admitting less nuanced description. 

Some of these boundaries come from the richness of the non-living world: from the speed of light, to rates of reaction, to physical boundaries like oceans and mountain ranges. Interestingly, life also places limits on itself: humans precommit to avoid their own future impulsivity; plants deploy sophisticated barriers again self-fertilization.  

Life is its propensity to actively place limits on itself.
Example of sexual reproduction,  
This seems counterintuitive until you think about the fact that there are multiple entities, and they are placing bounds on one another.

Both the boundary and the thing being bounded are often parts of a living system. For example, cognitive control allows a particular impulse to exist usefully as a flexible part of the organism's whole motivation. Control doesn't destroy the impulse; it contextualizes it. 
...
That is to say, life places limits on itself. 
